...
class MyContract extends Contract {
    ...
    async jualBenih(
        ...
        batchBenih.usernamePenangkar = usernamePengirim;
        batchBenih.usernamePetani = usernamePenerima;
        batchBenih.alamatPenangkar = alamatPengirim;
        batchBenih.alamatPetani = alamatPenerima;
        batchBenih.kuantitastoPetani = kuantitas;
        batchBenih.hargatoPetani = harga;
        batchBenih.timestamptoPetani = timestamp;
        batchBenih.umurBenih = umurBenih;
        batchBenih.umurPanen = umurPanen;
        batchBenih.lamaPenyimpanan = lamaPenyimpanan;
        ...
        batchBenih.transaksiIDtoPetani = transaksiID;
        batchBenih.batchID = batchID;
    ...
    async jualBawangPengumpul(
        ...
        batchBawang.usernamePetani = usernamePengirim;
        batchBawang.usernamePengumpul = usernamePenerima;
        batchBawang.alamatPetani = alamatPengirim;
        batchBawang.alamatPengumpul = alamatPenerima;
        batchBawang.kuantitastoPengumpul = kuantitas;
        batchBawang.hargatoPengumpul = harga;
        batchBawang.timestamptoPengumpul = timestamp;
        batchBawang.ukuranUmbi = ukuranUmbi;
        batchBawang.kadarAir = kadarAir;
        batchBawang.pupuk = pupuk;
        batchBawang.pestisida = pestisida;
        ...
        batchBawang.produktivitas = produktivitas;
        batchBawang.statustoPengumpul = status;
        batchBawang.transaksiIDtoPengumpul = transaksiID;
        batchBawang.batchID = batchID;
    ...
    async jualBawangPedagang(
        ...
        batchBawang.usernamePengumpul = usernamePengirim;
        batchBawang.usernamePedagang = usernamePenerima;
        batchBawang.alamatPengumpul = alamatPengirim;
        batchBawang.alamatPedagang = alamatPenerima;
        batchBawang.kuantitastoPedagang = kuantitas;
        batchBawang.hargatoPedagang = harga;
        batchBawang.timestamptoPedagang = timestamp;
        batchBawang.tanggalMasuk = tanggalMasuk;
        batchBawang.alamatGudang = alamatGudang;
        batchBawang.teknikSorting = teknikSorting;
        batchBawang.metodePengemasan = metodePengemasan;
        batchBawang.statustoPedagang = status;
        batchBawang.transaksiIDtoPedagang = transaksiID;
        batchBawang.batchID = batchID;
