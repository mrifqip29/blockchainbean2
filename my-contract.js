...
class MyContract extends Contract {
     ...
     * @param memberType - can be grower, shipper, trader and retailer (penangkar, petani, pengumpul, pedagang)
     */
    ...
    async addCoffee(
        ...
        await ctx.stub.putState(
            batchId,
            Buffer.from(JSON.stringify(batchCoffee))
        );
    ...
    async submitFairTradeData(
        ctx,
        reportName,
        orgDescription,
        reportYear,
        fairTradePremiumInvested,
        investmentTitle1,
        investmentAmount1,
        investmentTitle2,
        investmentAmount2,
